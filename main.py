...
parser.add_argument("--lc_verify", type=str, default="attn", choices=["bypass", "attn"], help="How the DVLT backbone produces image_match_ratio for loop-closure verification. 'bypass' accepts every retrieved loop; 'attn' hooks the shared block's global attention at --lc_attn_step")
parser.add_argument("--lc_attn_step", type=int, default=None, help="Iteration k to read attention from when --lc_verify=attn. Default: the same relative depth as VGGT's target_layer (20 of 24)")
